    ...
    <div className='about-us'>
      ...
      <div className='about-details'>
        <div className='about-detail-item'>
          <strong>OPD Timings:</strong> Monday to Saturday, 9:00 AM - 1:00 PM & 2:00 PM - 5:00 PM
        </div>
        <div className='about-detail-item'>
          <strong>Ambulance:</strong> 24x7 Available
        </div>
        <div className='about-detail-item'>
          <strong>Emergency Contact:</strong> 1346-257400
        </div>
      </div>
    </div>
  )
